 ...
 *   about time scheduling and then textual description of command
...
public class TaskMetadata implements Serializable {
    ...
    /**
     * Stores textual description of command which will be executed.
     * Can be further processed, for example it can contain xml tags
     *   which can alter default way of execution.
     */
