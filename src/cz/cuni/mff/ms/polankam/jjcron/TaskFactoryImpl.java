...
/**
 * Implementation of task creation factory interface. By default it creates
 * {@link CmdTask} or tasks which are loaded from reflection using name defined
 * in crontab.
 *
 * @author Neloop
 */
public class TaskFactoryImpl implements TaskFactory {
    ...
    /**
     * From provided {@link TaskMetadata} information create implementation of
     * abstract {@link Task}. If loaded command string is encapsulated with
     * <code>class</code> tag then name inside is taken as name of Java class
     * and is tried to load using reflection and if successful then returned.
     * Classical crontab command without any tags is evaluated as command line
     * command and {@link CmdTask} is returned.
     *
